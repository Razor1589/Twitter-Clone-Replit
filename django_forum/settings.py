...
SECRET_KEY = 'django-insecure-izy4*-t2g-$ymx55qmppu95+9*#1le59d$wxvcx+b^rq!=#ssu'
...
cloudinary.config(
    cloud_name="kristiankshl",
    api_key="482941231352759",
    api_secret="HfkvBzXVd-nbZwDrMLqcH1gYtmc",
    secure=True
)
